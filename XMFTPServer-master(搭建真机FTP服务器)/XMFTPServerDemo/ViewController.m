...
- (void)generateTestFiles
{
    ...
    [docText writeToFile:[[NSSearchPathForDirectoriesInDomains(NSDocumentDirectory, NSUserDomainMask, YES) firstObject]stringByAppendingPathComponent:[NSString stringWithFormat:@"xmftp_doc_test_files_%@", [fmt stringFromDate:nowDate]]] atomically:YES encoding:NSUTF8StringEncoding error:nil];
